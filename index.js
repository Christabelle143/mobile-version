...
const projectList = [{
		...
		work: 'Back End Dev',
		date: 2015,
		description:'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the releaLorem Ipsum is simply dummy text of the printing',
...
function handleClick(e) {
  const index = e.path[0].id;//what does the zero and 3 means.
...
const closeModal = () => {
	...
	const modal_bg = document.querySelector('.mobile_window')
    btnClose.addEventListener('click', (e) => {
		console.log('hello')
      e.path[3].remove();//what does the zero and 3 means.
      document.body.classList.remove('no-scroll');
  ...
  <div class="container2">
      <div class="projects projects2">
        ...
        <div class="popup_img_div">
          <img class="popup_project_photo" src="${prop[idx].image}" alt="First project's image" />
        </div>
       <div class="position">
        ...
        <div class="navigation-links">
            <a href="#" class="flex source">See Live<img src="images/Icon.png" alt="see-live-icon"></a>
      		<a href="" target="_blank" class="flex source">See Source<img src="images/git.png" alt="github-logo"></a>
        </div>
       </div>
       </div>
      </div>
